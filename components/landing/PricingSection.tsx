export default function PricingSection() {
  return (
    <section id="pricing" className="py-24 px-6" style={{ backgroundColor: "#2F4F4F" }}>
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="relative inline-block rounded-3xl p-12 mb-16 shadow-2xl overflow-hidden" style={{ backgroundColor: "#1A2F2F", border: "1px solid rgba(245,158,11,0.3)" }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 text-left">
          {[
            ...
            <div key={f.title} className="rounded-2xl p-5" style={{ backgroundColor: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.08)" }}>
