...
function AdminLoginForm() {
  ...
  useEffect(() => {
    if (searchParams.get("error") === "unauthorized") {
      setServerError("You must be logged in as an admin to access that page.");
    }
  }, [searchParams]);
      ...
      >
        ...
        <div className="relative z-10 space-y-8">
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              { value: "Deliveries", label: "Full order management" },
              { value: "Drivers",    label: "Fleet oversight" },
              { value: "Users",      label: "Account control" },
              { value: "Pricing",    label: "Rate configuration" },
            ].map((stat) => (
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div>
            <div
              ...
              style={{ backgroundColor: "rgb(239 68 68 / 0.1)", color: "var(--color-error)" }}
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-5" noValidate>
            ...
            <div>
              ...
              <input
                ...
                placeholder="admin@ezygocouriers.co.za"
          ...
          <p className="text-center text-xs" style={{ color: "var(--color-text-muted)" }}>
            Having trouble?{" "}
            <a
              href="mailto:support@ezygocouriers.co.za"
